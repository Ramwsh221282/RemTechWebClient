...
@Component({
  selector: 'app-scrapers-management-parser-link-editing-doc',
  imports: [
    BlueInfoTextComponent,
    GrayTextInfoComponent,
    GrayTextInfoWrapperComponent
  ],
  templateUrl: './scrapers-management-parser-link-editing-doc.component.html',
  styleUrl: './scrapers-management-parser-link-editing-doc.component.scss'
})
export class ScrapersManagementParserLinkEditingDocComponent {
