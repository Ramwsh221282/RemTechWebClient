...
@Component({
  selector: 'app-scrapers-management-parser-instant-disable-doc',
  imports: [
    BlueInfoTextComponent,
    GrayTextInfoComponent,
    GrayTextInfoWrapperComponent
  ],
  templateUrl: './scrapers-management-parser-instant-disable-doc.component.html',
  styleUrl: './scrapers-management-parser-instant-disable-doc.component.scss'
})
export class ScrapersManagementParserInstantDisableDocComponent {
