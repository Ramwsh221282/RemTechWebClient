...
@Component({
  ...
  imports: [CardModule, PanelModule, DividerModule, ParsersListComponent, ProfilesListComponent, ProfileInfoComponent, InputText, Button, FormsModule],
...
export class AdminParsersPanelComponent implements OnInit {
  ...
  public constructor(titleService: Title, viewModel: ParserPanelViewModel, httpService: ParserHttpService) {
  ...
  public ngOnInit(): void {
    this._httpService.fetchParsers().subscribe((response: Envelope<Parser[]>) => {
